...
@dag(dag_id='war_dag_4_2', schedule_interval=None, tags=['war_dag_4_2'], render_template_as_native_obj=True, default_args=default_args)
def war_dag_test():
    ...
    def process_pending_withdrawals(conn, battle_date: datetime):
        ...
        try:
            ...
            for withdrawal_id, account_id, amount in pending_withdrawals:
                ...
                allocation_query = """
                SELECT allocation_id FROM war_iter_4_2.allocation
                """
    ...
    def liquidate(conn, battle_date):
        """
        Fetches all allocations from war_iter_4_2.allocation and processes them for removal.
        """
        query = "SELECT * FROM war_iter_4_2.allocation"
        try:
            with conn.cursor() as cur:
                cur.execute(query)
